          ...
          {filtered.map((o, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-white/10 bg-card/60 backdrop-blur-xl"
              >
                ...
                {o.image_url && (
                  <div className="relative h-40 w-full overflow-hidden">
                    <img src={o.image_url} alt={o.title} className="h-full w-full object-cover transition duration-500 group-hover:scale-105" />
                ...
                <div className="p-6">
                  ...
                  <div className="mt-5 flex items-center justify-between gap-2 border-t border-white/5 pt-4">
                    ...
                    <div className="flex items-center gap-2">
                      {r && <ReviewsButton targetType="restaurant" targetId={r.id} targetName={r.name} label="Review" />}
